...
class SuiteDecoration extends Decoration {
...
class _DottedDecotatorPainter extends BoxPainter {
  ...
  List<int> dash;
  double strokeWidth;
  _DottedDecotatorPainter(this.shape, this.linePosition, this.color, this.borderRadius,
      this.dash, this.strokeWidth) {
